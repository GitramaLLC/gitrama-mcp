...
|-----------|----------|--------|------------|
| AI Server | Railway | US | SOC 2 (Railway) |
| Provisioning API | Railway | US | SOC 2 (Railway) |
| Database | Supabase | US | SOC 2, HIPAA eligible |
| Email | Resend | US | SOC 2 |
| DNS | Cloudflare | Global | SOC 2, ISO 27001 |
